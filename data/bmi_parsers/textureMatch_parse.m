...
ST_IN_CENTER = 3;
ST_EXPLORE = 4;
ST_IN_SAMPLE_TARGET = 5;
ST_IN_CORRECT_TARGET = 6;
ST_IN_WRONG_TARGET = 7;	
ST_REWARD = 8;
ST_ERR_GENERIC = 9;
ST_ERR_TIMEOUT = 10;
ST_ERR_CANCELED = 11;
...
try
	[trial.sample_target_radius] = parse(d2r(sample_target_size));
catch
	[trial.sample_target_radius] = [trial.target_radius];
end
