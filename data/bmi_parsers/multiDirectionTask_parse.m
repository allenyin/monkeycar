% FITTSTASK2_PARSE 
%
% $Id: fittsTask2_parse.m 828 2010-07-15 06:55:20Z joey $
% 
...
%%new to this task compared with previous
[trial.target_theta3] = dealify([trial.outcome_t],target_2_location_angle,'previous');  %location of large target
[trial.target_theta4] = dealify([trial.outcome_t],target_width_2,'previous');            %width of large target
